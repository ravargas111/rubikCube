...
public class FlowController {
    ...
    private FXMLLoader getLoader(String name) {
        ...
        if (loader == null) {
            synchronized (FlowController.class) {
                if (loader == null) {
                    try {
                        loader = new FXMLLoader(RubikCube.class.getResource("view/" + name + ".fxml"), this.idioma);
                        loader.load();
    ...
    public void goMain() {
        try {
            this.mainStage.setScene(new Scene(FXMLLoader.load(RubikCube.class.getResource("view/Container.fxml"), this.idioma)));
            this.mainStage.show();
